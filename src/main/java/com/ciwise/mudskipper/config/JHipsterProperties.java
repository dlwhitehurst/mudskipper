...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "mudskipper@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "mudskipper API";

        private String description = "mudskipper API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "mudskipper";
